			...
			<table cellspacing="15px">
				<tr>
					...
					<td><input class="easyui-combobox" id="serveType"
						name="serveType"
						data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${ctx}/data_dic/queryServeType'" />&nbsp;<font
						color="red">*</font></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>客户：</td>
				...
				<tr>
					...
					<td><a href="javascript:saveCustomerService()"
						class="easyui-linkbutton" iconCls="icon-ok">保存</a>&nbsp;&nbsp; <input
						class="easyui-linkbutton" type="reset"
						iconCls="icon-reset">重置</input></td>
				</tr>
			</table>
		</form>
	</div>
