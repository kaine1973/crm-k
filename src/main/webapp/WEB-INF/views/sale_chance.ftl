...
<div id='dlg' class="easyui-dialog" style="width: 500px;height: 400px" title="添加营销机会记录" buttons="#bt" closed="true">
    <form id="fm" class="form-body" method="post">
        ...
        成功几率:<input name="cgjl" required=true class="easyui-validatebox" value="" type="number"/><br/><br/>

        概要:<input name="overview" type="text"/><br/>
        联系人:<input name="linkMan" required=true class="easyui-validatebox" value="" type="text"/><br/>
        联系电话:<input name="linkPhone" required=true class="easyui-validatebox" value="" type="text"/><br/>
